  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid sm:grid-cols-3 gap-4 mb-6">
        {[
          { icon: Activity, label: 'Active Queues', value: '12', iconColor: 'text-success-500' },
          { icon: Users, label: 'Total Waiting', value: '47', iconColor: 'text-primary-500' },
          { icon: Clock, label: 'Avg Wait Time', value: '6 min', iconColor: 'text-accent-500' },
        ].map(s => (
      ...
      <Card>
        <div className="px-6 py-4 border-b border-surface-100 dark:border-surface-800 flex items-center justify-between">
          <h3 className="font-semibold text-surface-900 dark:text-white">Dr. Ahmed Khan — Room 201</h3>
